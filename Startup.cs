...
using ApplicationMember.Data.Extension;
...
using Onboarding.Handlers.ImageHandler;
using System;
using System.Collections.Generic;
using System.Linq;
using System.Threading.Tasks;

namespace ApplicationMember
{
    public class Startup
    {
        ...
        opt.UseNpgsql(Configuration.GetConnectionString("DefaultConnection")));
            ...
            services.AddScoped<IExporterHandler,ExportHandler > ();
        }
